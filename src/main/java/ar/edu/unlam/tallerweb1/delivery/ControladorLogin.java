...
public class ControladorLogin {
	...
	// es decir, qeue lo parametros del mismo deben ser un bean de spring y el framewr!ok automaticamente pasa como parametro
	...
	@RequestMapping(value = "/guardar-menu", method = RequestMethod.POST)
	public ModelAndView guardarManu(@ModelAttribute("datosMenu") DatosMenu datosMenu) {

		List<DatosMenu> listaMenu = new ArrayList<>();
		listaMenu.add(datosMenu);
		ModelMap modelo = new ModelMap();
		modelo.put("menu", listaMenu);
	...
	public ModelAndView crearMenu() {
		...
		return new ModelAndView("agregar-menu", modelo);
	}
